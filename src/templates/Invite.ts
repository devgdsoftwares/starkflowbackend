...
export default class Invite {
    ...
    static generateEmployerInviteTemplate(details:any) {
            ...
            <body>
                <table style="table-layout:fixed;border:1px solid #afb8c2" class="m_-9138196761631881432em_main_table" width="640"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="background-position:center top;background-size:cover;" valign="top"
                                align="center">
                                            ...
                                            <td valign="top" align="center">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="m_-9138196761631881432em_font1"
                                                                style="font-family:Helvetica-light,sans-serif;font-size:28px;line-height:45px;color:#000;letter-spacing:0.5px"
                                                                valign="top" align="center">Your account has been
                                                                created</td>
                                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" align="center">
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="m_-9138196761631881432em_h40" height="10">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-family:Helvetica-light,sans-serif;font-size:16px;line-height:25px;color:#414252"
                                                                valign="top" align="left">Welcome and accept our invitation
                                                                to the network where you'll
                                                                get matched with
                                                                what you're looking for in just a click.
                                                                <br><br>
                                                                Use the credentials below to sign in and feel free to reset the
                                                                password anytime:
                                                                <br><br>
                                                                Name: ${details.name}
                                                                <br><br>
                                                                            ...
                                                                            <td align='center'
                                                                                ...
                                                                                <table border='0' cellpadding='0' cellspacing='0'
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td
                                                                                                style='font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #6200EE; border-radius: 5px; text-align: center;'>
                                                                                                <a href='https://qa.starkflow.co/login/client'
                                                                                                    target='_blank'
                                                                                                    style='display: inline-block; color: #ffffff; background-color: #6200EE; border: solid 1px #6200EE; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #6200EE;'>Explore
                                                                                                    Now</a> </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                ...
                                                                <br>
                                                                <p style="margin-top:0!important">If you believe that you're not the
                                                                    intended user or you’ve received this in error, please contact
                                                                    <a href="mailto:contact@starkflow.co"
                                                                        style="color:#6200EE;text-decoration:none;outline:none;border:0"
                            ...
                            <td style="border-collapse:collapse" valign="top" bgcolor="#ffffff" align="center">
                                <table style="border-collapse:collapse" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="m_-9138196761631881432em_ftrlink"
                                                style="font-family:Helvetica-light,sans-serif;font-size:15px;line-height:20px;color:#9d9d9d"
                                        ...
                                        <tr>
                                            <td style="font-size:1px;line-height:1px" class="m_-9138196761631881432em_h30"
                                                height="16">&nbsp;</td>
                                        </tr>
